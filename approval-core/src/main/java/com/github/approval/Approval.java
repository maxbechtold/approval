...
public class Approval<T> {
    ...
    Approval(Reporter reporter, Converter<T> converter, @Nullable PathMapper<T> pathMapper) {
        this(reporter, converter, pathMapper, new com.github.approval.utils.DefaultFileSystemUtils());
    }
     ...
     */
    Approval(Reporter reporter, Converter<T> converter, @Nullable PathMapper<T> pathMapper, com.github.approval.utils.FileSystemUtils fileSystemReadWriter) {
